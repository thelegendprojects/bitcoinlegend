/* src/config/bitcoinlegend-config.h.  Generated from bitcoinlegend-config.h.in by configure.  */
/* src/config/bitcoinlegend-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "www.bitcoinlegend.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Bitcoinlegend Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Bitcoinlegend Core 3.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "bitcoinlegend"

...
BOOST_AUTO_TEST_CASE(merkle_block_4)
{
    ...
    filter.insert(uint256("0x02981fa052f0481dbc3310f4fc2166035a10f27a03cfd2de67326471df5bc041"));
    merkleBlock = CMerkleBlock(block, filter);
    BOOST_CHECK(merkleBlock.header.GetHash() == block.GetHash());

    BOOST_CHECK(merkleBlock.vMatchedTxn.size() == 2);

    BOOST_CHECK(merkleBlock.vMatchedTxn[0].second == uint256("0x02981fa052f0481dbc3310f4fc2166035a10f27a03cfd2de67326471df5bc041"));
...
BOOST_AUTO_TEST_CASE(merkle_block_4_test_p2pubkey_only)
{
    ...
    BOOST_CHECK(!filter.contains(COutPoint(uint256("0x02981fa052f0481dbc3310f4fc2166035a10f27a03cfd2de67326471df5bc041"), 0)));
}

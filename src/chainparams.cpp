...
public:
    CMainParams()
    {
        ...
        vAlertPubKey = ParseHex("04ed3a7fc9d0aa2b6bfe9f7c65f97119690eeee21f556d0c30416c49111e6ac9b26d8609dbbf652f385d729e6ad34d27be7d9cc0881a01b1e2cd75c57ef801a38b");
        nDefaultPort = 22436;
       bnProofOfWorkLimit = ~uint256(0) >> 20;
        ...
        const char* pszTimestamp = "BITCOINLEGEND - arrived with new Developer Team.";
        CMutableTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CScriptNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 0 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("040061bc1ea258e05361adb5558147d2cc66fd3bf610380b55bef933bb2a24bd4d58b7ff4241ed0204e93c04b3c572385303bbca26a220711e0ff956549168de93") << OP_CHECKSIG;
        genesis.vtx.push_back(txNew);
        genesis.hashPrevBlock = 0;
        genesis.hashMerkleRoot = genesis.BuildMerkleTree();
        genesis.nVersion = 1;
        genesis.nTime = 1610313453;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 373813;
	/*if(genesis.GetHash() != uint256("0x"))
        ...
        assert(hashGenesisBlock == uint256("0x00000b2fe7a282a7da6931ec3be6b1c4377e27d62c5b732dfd988498793dd4e7"));
        assert(genesis.hashMerkleRoot == uint256("0x3ba93c9159cf3c6ce2bd7de66acb8f13988b25dfe6d5a8a60a9dced94d578a3a"));
		
		vSeeds.push_back(CDNSSeedData("64.225.52.64", "64.225.52.64"));   // Primary DNS Seeder
		vSeeds.push_back(CDNSSeedData("134.122.6.57", "134.122.6.57"));
		vSeeds.push_back(CDNSSeedData("134.122.4.253", "134.122.4.253"));
...
public:
    CTestNetParams()
    {
        ...
        nMinerThreads = 0;
        nTargetTimespan = 1 * 60; // Bitcoinlegend: 1 day
        nTargetSpacing = 1 * 60;  // Bitcoinlegend: 1 minute
        nLastPOWBlock = 200;
        nMaturity = 15;
        ...
        vFixedSeeds.clear();
        vSeeds.clear();
        vSeeds.push_back(CDNSSeedData("testnet.bcl.io", "testnet.bcl.io"));         // Single node address
        vSeeds.push_back(CDNSSeedData("testnet1.bcl.io", "testnet1.bcl.io"));       // Single node address
        vSeeds.push_back(CDNSSeedData("testnet.bitcoinlegendcoin.org", "testnet.bitcoinlegendcoin.org"));       // Single node address


        base58Prefixes[PUBKEY_ADDRESS] = std::vector<unsigned char>(1, 139); // Testnet bitcoinlegend addresses start with 'x' or 'y'
        base58Prefixes[SCRIPT_ADDRESS] = std::vector<unsigned char>(1, 19);  // Testnet bitcoinlegend script addresses start with '8' or '9'
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 239);     // Testnet private keys start with '9' or 'c' (Bitcoin defaults)
        // Testnet bitcoinlegend BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet bitcoinlegend BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet bitcoinlegend BIP44 coin type is '1' (All coin's testnet default)
...
public:
    CRegTestParams()
    {
        ...
        nToCheckBlockUpgradeMajority = 1000;
        nMinerThreads = 1;
        nTargetTimespan = 24 * 60 * 60; // Bitcoinlegend: 1 day
        nTargetSpacing = 1 * 60;        // Bitcoinlegend: 1 minutes

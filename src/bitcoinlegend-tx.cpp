...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Bitcoinlegend Core bitcoinlegend-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  bitcoinlegend-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bitcoinlegend transaction") + "\n" +
                               "  bitcoinlegend-tx [options] -create [commands]   " + _("Create hex-encoded bitcoinlegend transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded bitcoinlegend transaction

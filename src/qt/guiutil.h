...
/** Utility functions used by the Bitcoinlegend Qt UI.
 */
namespace GUIUtil
{
...
// Render Bitcoinlegend addresses in monospace font
...
// Parse "bitcoinlegend:" URI into recipient object, return true on successful parsing

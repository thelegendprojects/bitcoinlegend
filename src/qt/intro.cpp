...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Bitcoinlegend [BCL]"),
     ...
     * override -datadir in the bitcoinlegend.conf file in the default data directory
     * (to be consistent with bitcoinlegendd behavior)
     */
    if (dataDir != getDefaultDataDirectory())

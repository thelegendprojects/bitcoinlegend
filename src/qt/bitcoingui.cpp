                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Bitcoinlegend [BCL]") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Bitcoinlegend address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and bitcoinlegend: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zBCL"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Bitcoinlegend Core"), this);
    aboutAction->setStatusTip(tr("Show information about Bitcoinlegend Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Bitcoinlegend"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Bitcoinlegend addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Bitcoinlegend addresses"));
    ...
    openAction->setStatusTip(tr("Open a Bitcoinlegend: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Bitcoinlegend Core help message to get a list with possible Bitcoinlegend command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Bitcoinlegend Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Bitcoinlegend network", "", count));
}
...
{
    QString strTitle = tr("Bitcoinlegend [BCL]"); // default title

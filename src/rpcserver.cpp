...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop Bitcoinlegend server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "Bitcoinlegend server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Bitcoinlegend features */
        {"bitcoinlegend", "masternode", &masternode, true, true, false},
        {"bitcoinlegend", "listmasternodes", &listmasternodes, true, true, false},
        {"bitcoinlegend", "getmasternodecount", &getmasternodecount, true, true, false},
        {"bitcoinlegend", "masternodeconnect", &masternodeconnect, true, true, false},
        {"bitcoinlegend", "masternodecurrent", &masternodecurrent, true, true, false},
        {"bitcoinlegend", "masternodedebug", &masternodedebug, true, true, false},
        {"bitcoinlegend", "startmasternode", &startmasternode, true, true, false},
        {"bitcoinlegend", "createmasternodekey", &createmasternodekey, true, true, false},
        {"bitcoinlegend", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"bitcoinlegend", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"bitcoinlegend", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"bitcoinlegend", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"bitcoinlegend", "getmasternodescores", &getmasternodescores, true, true, false},
        {"bitcoinlegend", "mnbudget", &mnbudget, true, true, false},
        {"bitcoinlegend", "preparebudget", &preparebudget, true, true, false},
        {"bitcoinlegend", "submitbudget", &submitbudget, true, true, false},
        {"bitcoinlegend", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"bitcoinlegend", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"bitcoinlegend", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"bitcoinlegend", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"bitcoinlegend", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"bitcoinlegend", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"bitcoinlegend", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"bitcoinlegend", "checkbudgets", &checkbudgets, true, true, false},
        {"bitcoinlegend", "mnsync", &mnsync, true, true, false},
        {"bitcoinlegend", "spork", &spork, true, true, false},
        {"bitcoinlegend", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"bitcoinlegend", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use bitcoinlegendd, or the -server option to bitcoinlegend-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> bitcoinlegend-cli " + methodname + " " + args + "\n";
}

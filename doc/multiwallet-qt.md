...
In order to support loading of multiple wallets in bitcoinlegend-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is bitcoinlegend.cpp.
...
Changes to bitcoinlegend.cpp
----------------------
bitcoinlegend.cpp is the entry point into bitcoinlegend-qt, and as such, will require some minor modifications to provide hooks for

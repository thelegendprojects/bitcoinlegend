Contributing to Bitcoinlegend Core
============================

The Bitcoinlegend Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Bitcoinlegend Core project, and is not to be
confused with overall Bitcoinlegend Network Protocol consensus changes.

Whether a pull request is merged into Bitcoinlegend Core rests with the project merge
...
Patches that change Bitcoinlegend consensus rules are considerably more involved than
...
Where a patch set proposes to change the Bitcoinlegend consensus, it must have been
...
The project leader is the release manager for each Bitcoinlegend Core release.
